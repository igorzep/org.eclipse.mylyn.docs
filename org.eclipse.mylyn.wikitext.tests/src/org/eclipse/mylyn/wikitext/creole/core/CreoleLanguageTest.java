...
public class CreoleLanguageTest extends TestCase {
	...
	public void testHeadings() {
		for (int level = 1; level <= 6; ++level) {
			...
			String[] headingMarkupSamples = new String[] {
					delimiter + " heading text ",
					delimiter + "\t heading text \t",
					delimiter + "heading text" + delimiter,
					delimiter + "\t heading text \t" + delimiter,
					delimiter + "heading text" + delimiter + " \t ",
					"\t " + delimiter + "heading text",
			};
			...
			for (String headingMarkup : headingMarkupSamples) {
				...
				assertEquals("<h" + level + " id=\"headingtext\">heading text</h" + level + ">"
			...
			for (String headingMarkup : headingMarkupSamples) {
				...
				assertEquals("<p>para</p>"
						+ "<h" + level + " id=\"headingtext\">heading text</h" + level + ">"
						+ "<p>para</p>", content(html));
			}
		}
	}
	...
	public void testItalicLink2() {
		...
		assertEquals("<p>normal <i><a href=\"http://example.com\">http://example.com</a>"
				+ " <a href=\"https://example.com\">https://example.com</a></i> normal</p>",
				content(html));
	}
	...
	public void testBoldItalicEOL() {
		...
		TestUtil.println(html);
		assertEquals("<p>normal <b>bold</b> or <i>italic</i> or <b><i>both</i>bold</b></p>",
				content(html));
	}
